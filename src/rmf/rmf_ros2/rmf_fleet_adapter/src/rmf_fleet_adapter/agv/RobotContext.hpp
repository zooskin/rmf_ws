...
public:
  ...
  /// Get the actual final destination name of the current plan (for VDA5050
  /// Base/Horizon ordering).
  std::string plan_final_name() const;

  /// Set the actual final destination name of the current plan.
  void set_plan_final_name(const std::string& name);
